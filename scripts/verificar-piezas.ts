...
const EXCEPCIONES: { prefijo: string; razon: string }[] = [
  ...
  { prefijo: "app/(app)/admin/personas/page.tsx", razon: "casilla: el buscador es <input type=\"search\">, que Campo no cubre todavía (mismo hueco que url/fecha), con las clases de Campo y su propia etiqueta; botón: falso positivo del regex (ese mismo input nativo hace \"border border-hp-2\" → coincide con el patrón de botón sin serlo)" },
